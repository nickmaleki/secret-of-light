...
Philosophically, and In The Context of The Big Bang, This Quote Makes Sense. There was nothing then something. But how could this be possible, how could nothingness, 0, turn into something? Analogously, how could 0 = x? Well, in "modern/Modern" Algebra (I wrote this little parenthesized note on 3/23/2022 ACE/AD/CE and you wrote this on 4/20, We Can Communicate Across Time), the only solution to this system is x = 0. And 0 is Higher Than You Think. But Walter Russel argues that it is possible to leave 0 (which he deems the inertial line) by extending towards positive numbers, but every time you leave 0 towards the positive direction you must come back to 0 by extending towards the negative direction. An Example of This Extension is the Sin Wave. Where you leave 0 by extending towards positive 1 and come back to 0 by extending towards -1. If you sample an "arbitrary/Arbitrary" Alphabet (x)/*/Star value, perhaps x = π, The Literal Ratio Between A Square and A Circle: you will see y change over time but y will never leave 0. The image above is extremely useful in showing this idea, imagine adding many waves together but the net sum of all of the waves is still 0. Something equals nothin'
