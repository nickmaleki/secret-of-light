...
### Old commits that look cool. And, as a non-scientist/believer, I belive This Gif Is What Will Bring Deep Meaning to Walter's Model of the/The Atom. 
...
Philosophically, and In The Context of The Big Bang, This Quote Makes Sense. There was nothing then something. But how could this be possible, how could nothingness, 0, turn into something? Analogously, how could 0 = x? Well, in "modern/Modern" Algebra (I wrote what is in these parenthesis on 3/23/2022 ACE/AD/CE and you wrote this on 4/20 or literally any other day you want. We Can Communicate Across Time), the only solution to this system is x = 0. And 0 is "Higher/Better" Than You Think. But Walter Russel argues that it is possible to leave 0 (which he deems the inertial line) by extending towards positive numbers, but every time you leave 0 towards the positive direction you must come back to 0 by extending towards the negative direction. An Example of This Extension is the Sin Wave. Where you leave 0 by extending towards positive 1 and come back to 0 by extending towards -1. If you sample an "arbitrary/Arbitrary" part of the Alphabet - a letter like (x) or a wildcard like /*/Star. Where the numerical value of this can be wholey arbitrary, perhaps x = π. Pi is The Literal Ratio Between A Square and A Circle: you will see y change over time but y will never leave 0. The image above is extremely useful in showing this idea, imagine adding many waves together but the net sum of all of the waves is still 0. Something equals nothin'
